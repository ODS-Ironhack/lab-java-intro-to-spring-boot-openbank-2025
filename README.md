...
- **Imagen**:  
<img src="src/main/resources/images/Image.01.19.png" alt="Get all doctors" width="400"/>

### 2. **Get doctor by ID**
- **Ruta**: `/doctors/{id}`
- **Descripción**: Crea una ruta para obtener un médico a partir de su `employee_id`.
- **Imagen**:  
<img src="src/main/resources/images/Image.59.53.png" alt="Get doctor by ID" width="400"/>
...
- **Imagen**:  
<img src="src/main/resources/images/Image.03.28.png" alt="Get doctors by status" width="400"/>
...
- **Imagen**:  
<img src="src/main/resources/images/Image.03.57.png" alt="Get doctors by department" width="400"/>

### 5. **Get all patients**
- **Ruta**: `/patients`
- **Descripción**: Crea una ruta para obtener todos los pacientes registrados en el sistema.
- **Imagen**:  
<img src="src/main/resources/images/Image.12.05.png" alt="Get all patients" width="400"/>

### 6. **Get patient by ID**
- **Ruta**: `/patients/{id}`
- **Descripción**: Crea una ruta para obtener un paciente a partir de su `id`.
- **Imagen**:  
<img src="src/main/resources/images/Image.16.52.png" alt="Get patient by ID" width="400"/>
...
- **Imagen**:  
<img src="src/main/resources/images/Image.26.31.png" alt="Get patients by date of birth range" width="400"/>
...
- **Imagen**:  
<img src="src/main/resources/images/Image.30.19.png" alt="Get patients by admitting doctor's department" width="400"/>
...
- **Imagen**:  
<img src="src/main/resources/images/Image.35.11.png" alt="Get all patients with a doctor whose status is OFF" width="400"/>
